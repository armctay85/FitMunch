...
async function geminiChat({ system, messages, maxTokens, temperature, jsonMode }) {
  ...
  const body = JSON.stringify({
    ...
    generationConfig: {
      ...
      // Gemini 2.5 "thinking" tokens share maxOutputTokens; with tight budgets
      // the model can think through the whole budget and return empty text.
      // Flash supports disabling thinking entirely.
