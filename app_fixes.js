...
window.showWorkoutLog = function(exerciseName, exerciseDetails) {
  ...
  // Note: Exercise details pre-filling is handled within showWorkoutLog function above
  // Note: Exercise history loading is handled within showWorkoutLog function above
